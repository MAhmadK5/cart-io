...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/10 bg-zinc-950 pt-20 pb-10 overflow-hidden">
      ...
      {/* ✨ NEW: MASSIVE BACKGROUND WATERMARK ✨ */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-16 border-b border-white/5">
          ...
          />
            ...
            <div className="flex items-center gap-4 text-zinc-500">
              {/* Instagram */}
              <a href="https://www.instagram.com/cartio.pk?igsh=MTIzY293MHVsOXA0MA==&utm_source=ig_contact_invite" className="hover:text-white transition-colors">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/share/1KmDTRiPtK/?mibextid=wwXIfr" className="hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* TikTok */}
              <a href="https://www.tiktok.com/@cartio.pk?_r=1&_t=ZS-95yS6EaWPVl" className="hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/></svg>
              </a>
              <a href="https://x.com/cartiopk?s=21" className="hover:text-white transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              {/* ✨ Threads Logo Added ✨ */}
              <a href="https://www.threads.com/@cartio.pk?invite=0" className="hover:text-white transition-colors">
