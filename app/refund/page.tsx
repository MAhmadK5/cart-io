    ...
    <>
      ...
      <div className="min-h-screen pt-24 md:pt-32 pb-24 px-4 sm:px-8 relative z-10 max-w-5xl mx-auto animate-fade-in">
        ...
        <div className="mb-16 md:mb-20 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase leading-none">Return Policy</h1>
        ...
        <div className="bg-zinc-900/40 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 md:p-16 shadow-[0_0_50px_rgba(147,51,234,0.1)] space-y-12 md:space-y-16">
                 ...
                 <section>
            <h2 className="text-2xl md:text-3xl font-black text-red-600 uppercase tracking-tight mb-4 flex items-center gap-4">
            ...
            <p className="text-lg md:text-xl text-zinc-400 font-light leading-relaxed tracking-wide">
             Currently, we are operating as a growing startup, and while we strive to provide the best possible experience, we do not have a refund policy in place at this stage. This is primarily due to our current scale and the logistical constraints of being in the early phases of our journey. However, we are working hard to refine our systems and expand our capabilities. Inshallah, as we continue to scale, we look forward to implementing a comprehensive refund process soon to better serve our community and ensure your peace of mind. 
            </p>
          </section>
             <section>
            <h2 className="text-2xl md:text-3xl font-black text-yellow-400 uppercase tracking-tight mb-4 flex items-center gap-4">
              <span className="w-8 h-px bg-purple-500"></span>
              COMING SOON!
            </h2>
          </section>
          ...
          <div className="pt-10 border-t border-white/10 mt-12 text-center">
            <h3 className="text-xl font-bold text-white uppercase tracking-widest mb-6">Something left to ask? Contact: </h3>
