...
// Updated with professional Unsplash placeholder images
const trendingProducts = [
  { id: 1, name: "Aero-Blade MiNi Fan", price: "$35", category: "MiNi Fan", image: "https://images.unsplash.com/photo-1618301548057-074cd01538fc?q=80&w=600&auto=format&fit=crop" },
  { id: 2, name: "Matte Black Stanley 40oz", price: "$55", category: "Stanley tumblers", image: "https://images.unsplash.com/photo-1605273766641-766723b72ea9?q=80&w=600&auto=format&fit=crop" },
  { id: 3, name: "Velvet Smart-Weave Prayer Mat", price: "$85", category: "Prayer Mat", image: "https://images.unsplash.com/photo-1598514982205-f36b96d1e8dd?q=80&w=600&auto=format&fit=crop" },
  { id: 4, name: "Luminous AI-Formulated Serum", price: "$120", category: "Beauty products", image: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=600&auto=format&fit=crop" },
];
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-[85vh] text-center relative z-10 pb-10 w-full overflow-hidden px-4 mt-10 md:mt-0">
        ...
        <div className="mb-8 flex items-center gap-2 px-4 py-1.5 bg-black/40 backdrop-blur-md border border-white/10 rounded-full shadow-[0_0_15px_rgba(0,0,0,0.5)]">
          ...
          <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-300">Now Shipping Nationwide</span>
        </div>
        ...
        <img 
          src="/gobaazaar.png" 
          alt="GOBAAZAAR" 
          className="h-10 sm:h-14 md:h-20 w-auto object-contain transition-transform hover:scale-105 duration-500 brightness-0 invert drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] mb-8"
        />
        ...
        {/* Clear, Easy-to-Understand Paragraph */}
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto px-6 sm:px-0">
          ...
          <button className="w-full sm:w-auto px-10 py-4 bg-zinc-950/50 backdrop-blur-md border border-zinc-700 text-zinc-300 text-[10px] font-black uppercase tracking-[0.3em] rounded-xl hover:bg-orange-500/10 hover:border-orange-500 hover:text-orange-400 transition-all duration-300 shadow-lg flex items-center justify-center gap-3">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pb-16 w-full mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="group relative h-64 sm:h-72 rounded-[2rem] overflow-hidden flex items-center p-8 md:p-10 border border-orange-500/20 hover:border-orange-500/50 transition-all duration-500 shadow-[0_0_30px_rgba(249,115,22,0.05)] hover:shadow-[0_0_40px_rgba(249,115,22,0.15)] bg-black">
            <img src="https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?q=80&w=1000&auto=format&fit=crop" alt="Flash Sale" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-50 group-hover:scale-105 transition-all duration-700 z-0" />
            ...
            <div className="relative z-10 w-full">
              ...
              <h3 className="text-3xl sm:text-4xl font-black text-white leading-tight mb-3">
                Up to 30% Off <br/><span className="text-orange-400">Tumblers</span>
              </h3>
              <Link href="/market">
                <button className="mt-2 text-xs font-bold text-white uppercase tracking-widest flex items-center gap-2 hover:text-orange-400 transition-colors">
                  Shop The Sale <span className="group-hover:translate-x-1 transition-transform">→</span>
                </button>
              </Link>
            </div>
          </div>
          ...
          <div className="group relative h-64 sm:h-72 rounded-[2rem] overflow-hidden flex items-center p-8 md:p-10 border border-blue-500/20 hover:border-blue-500/50 transition-all duration-500 shadow-[0_0_30px_rgba(37,99,235,0.05)] hover:shadow-[0_0_40px_rgba(37,99,235,0.15)] bg-black">
            ...
            <div className="relative z-10 w-full">
              ...
              <h3 className="text-3xl sm:text-4xl font-black text-white leading-tight mb-3">
                Elevate Your <br/><span className="text-blue-400">Living Space</span>
              </h3>
              <Link href="/market">
                <button className="mt-2 text-xs font-bold text-white uppercase tracking-widest flex items-center gap-2 hover:text-blue-400 transition-colors">
                  Explore Decor <span className="group-hover:translate-x-1 transition-transform">→</span>
                </button>
              </Link>
            </div>
          </div>
      ...
      {/* --- FULL-BLEED MARQUEE SECTION --- */}
      <div 
        className="relative z-10 w-screen border-y border-white/5 bg-zinc-950/80 backdrop-blur-xl py-3 mb-24 shadow-2xl flex overflow-hidden" 
        style={{ marginLeft: 'calc(50% - 50vw)' }}
      >
        <div className="marquee-track flex shrink-0 items-center">
          {[...Array(8)].map((_, i) => (
            <div key={i} className="flex gap-12 items-center shrink-0 px-6">
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-zinc-400 flex items-center gap-3">
                FREE NATIONWIDE SHIPPING <span className="text-orange-500 text-lg">✦</span>
              </span>
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-zinc-400 flex items-center gap-3">
                CURATED PREMIUM GOODS <span className="text-blue-500 text-lg">✦</span>
              </span>
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-zinc-400 flex items-center gap-3">
                100% SECURE CHECKOUT <span className="text-orange-500 text-lg">✦</span>
              </span>
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-zinc-400 flex items-center gap-3">
                24/7 CUSTOMER SUPPORT <span className="text-blue-500 text-lg">✦</span>
              </span>
            </div>
          ))}
        </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pb-32">
        <div className="bg-zinc-900/40 backdrop-blur-2xl border border-white/10 rounded-3xl overflow-hidden flex flex-col lg:flex-row shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          <div className="w-full lg:w-1/2 h-[400px] lg:h-auto bg-black relative overflow-hidden flex items-center justify-center group">
            {/* Added real image */}
            <img src="https://images.unsplash.com/photo-1622353360440-2b2361661d9a?q=80&w=800&auto=format&fit=crop" alt="Stealth Stanley" className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-700" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pb-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {trendingProducts.map((product) => (
            <Link href="/market"
              key={product.id} 
              className="group relative bg-zinc-900/50 backdrop-blur-md border border-zinc-800 rounded-2xl p-4 transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_0_30px_rgba(37,99,235,0.15)] overflow-hidden cursor-pointer flex flex-col block"
            >
              <div className="w-full h-64 bg-black rounded-xl mb-4 relative overflow-hidden flex items-center justify-center">
                {/* Added real images to the product grid */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[220px]">
          ...
          <Link href="/market" className="md:col-span-2 group relative bg-black rounded-3xl overflow-hidden flex items-end p-8 transition-all hover:shadow-[0_0_30px_rgba(37,99,235,0.3)]">
            <img src="https://images.unsplash.com/photo-1614316130932-d17eb8a2e557?q=80&w=1000&auto=format&fit=crop" alt="Tumblers" className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:scale-105 group-hover:opacity-70 transition-all duration-700 z-0" />
          ...
          {/* 2. Beauty Products */}
          <Link href="/market" className="group relative bg-black rounded-3xl overflow-hidden flex items-end p-8 transition-all hover:shadow-[0_0_30px_rgba(249,115,22,0.3)]">
            <img src="https://images.unsplash.com/photo-1596462502278-27bfdc403348?q=80&w=600&auto=format&fit=crop" alt="Beauty" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:scale-105 group-hover:opacity-60 transition-all duration-700 z-0" />
          ...
          {/* 3. Prayer Mats */}
          <Link href="/market" className="group relative bg-black rounded-3xl overflow-hidden flex items-end p-8 transition-all hover:shadow-[0_0_30px_rgba(37,99,235,0.3)]">
            <img src="https://images.unsplash.com/photo-1584551246679-0daf3d275d0f?q=80&w=600&auto=format&fit=crop" alt="Prayer Mats" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:scale-105 group-hover:opacity-60 transition-all duration-700 z-0" />
            <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 via-zinc-950/50 to-transparent z-0"></div>
            <div className="relative z-10">
          ...
          {/* 4. MiNi Fan */}
          <Link href="/market" className="group relative bg-black rounded-3xl overflow-hidden flex items-end p-8 transition-all hover:shadow-[0_0_30px_rgba(249,115,22,0.3)]">
            <img src="https://images.unsplash.com/photo-1534008897995-27a23e859048?q=80&w=600&auto=format&fit=crop" alt="Fans" className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:scale-105 group-hover:opacity-60 transition-all duration-700 z-0" />
            <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 via-zinc-950/50 to-transparent z-0"></div>
            <div className="relative z-10">
